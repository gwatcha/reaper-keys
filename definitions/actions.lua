...
return {
      ...
      RecordTimeSelectionNormal = {"TransportStop", "TimeSelectionStart", "ArmAndToggleRecordNormal"},
      RecordTimeSelectionConditional = {"TransportStop", "TimeSelectionStart", "ArmAndToggleRecordConditional"},
      TransportStop = 1016,
      Record = {"RecordTimeSelectionNormal", setTimeSelection=true},
      Change = {"SetTrackRecMidiReplace", "SetAutomationModeLatchAndArm", "RecordTimeSelectionConditional", setTimeSelection=true},
      ArmAndToggleRecordConditional = {"TransportStop", "ArmSelectedTracks", "_SWS_AWRECORDCOND"},
      ArmAndToggleRecordNormal  = {"TransportStop", "ArmSelectedTracks", "SetRecordModeNormal", "ToggleRecord"},
      ToggleRecord = 1013,
      ToggleShowTracksInMixer = 41592,
      TransportRecordOrStop = "_SWS_RECTOGGLE",
      Append = {"SetTrackRecMidiOverdub", "SetAutomationModeLatchAndArm", "RecordTimeSelectionNormal", setTimeSelection=true},
      GoToLastItemAndRecord = {"LastItemEnd", "ArmAndToggleRecordNormal"},
      ...
      Reset = {"Stop", "SetModeNormal", "ResetTrackToNormal", "SetRecordModeNormal"},
      ResetTrackToNormal = {"UnarmSelectedTracks", "UnarmAllEnvelopes", "SetAutomationModeTrimRead", "SetRecordModeNormal"},
