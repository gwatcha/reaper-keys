...
return {
      ...
      GoToLastItemAndRecord = {"LastItemEnd", "ToggleRecordNormal"},
      ...
      RecordByAppending = {"SetTrackRecMidiTouchReplace", "RecordTimeSelectionNormal", setTimeSelection=true},
      RecordByChanging = {"SetTrackRecMidiReplace", "RecordTimeSelectionConditional", setTimeSelection=true},
      RecordByReplacing = {"SetTrackRecInput", "RecordTimeSelectionNormal", setTimeSelection=true},
      RecordMacro = "RecordMacro",
      Record = {"RecordTimeSelectionNormal", setTimeSelection=true},
      RecordTimeSelectionConditional = {"TransportStop", "TimeSelectionStart", "ToggleRecordConditional"},
      RecordTimeSelectionNormal = {"TransportStop", "TimeSelectionStart", "ToggleRecordNormal"},
      Redo = 40030,
      ...
      ToggleRecord = 1013,
      ToggleRecordConditional = {"TransportStop", "_SWS_AWRECORDCOND"},
      ToggleRecordingAutoScroll = 40262,
      ToggleRecordingPreroll = 41819,
      ToggleRecordNormal  = {"TransportStop", "SetRecordModeNormal", "ToggleRecord"},
