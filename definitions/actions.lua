...
return {
      ...
      ZoomFolder = {"SaveTrackSelection", "PrevFolderNear", "UncollapseFolder", "InnerFolder", "VerticalZoom", "RestoreTrackSelection"},
      ZoomAllTracks = {"ZoomProject",  "SaveTrackSelection",  "SelectAllTracks", "VerticalZoom", "RestoreTrackSelection"},
