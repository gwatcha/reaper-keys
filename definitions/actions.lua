...
return {
      ...
      MoveToMouseAndPlaySnap = {"MoveToMouseAndSnap", "TransportPlay"},
      MoveToMouseAndSnap = 40513,
      ...
      ProjectEnd = 40043,
      ProjectStart = 40042,
      ProjectTimeline = {"ProjectStart", "SetTimeSelectionStart", "ProjectEnd", "SetTimeSelectionEnd", {"UndoMove", repetitions=2}},
