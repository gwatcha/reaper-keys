...
return {
      ...
      FxClose = "_S&M_WNCLS5",
      FxShowNextSel = {"_S&M_WNONLY2", prefixRepetitionCount=true},
      FxShowPrevSel = {"_S&M_WNONLY1", prefixRepetitionCount=true},
      ...
      RecordMacro = {metaCommand=true, registerOptional=true},
