...
return {
      ...
      NextRegion = {"SaveLoopSelection", "SetLoopRegionToNextRegion", "SetTimeSelectionToLoopSelection", "RestoreLoopSelection"},
      NextTab = 40861,
      NextTake = 40125,
      NextTrack = 40285,
      ...
      PrevRegion = {"SaveLoopSelection", "SetLoopRegionToPrevRegion", "SetTimeSelectionToLoopSelection", "RestoreLoopSelection"},
