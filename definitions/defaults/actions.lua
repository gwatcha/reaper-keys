...
return {
      ...
      ShiftEnvelopePointsDown = 41181,
      ShiftEnvelopePointsDownATinyBit = 42382,
      ...
      Record = {"SaveEditCursorPosition", "TimeSelectionStart", "RecordConditional", "RestoreEditCursorPosition", "SetModeRecord", setTimeSelection=true},
      ...
      DuplicateTimeline = {"SaveTrackSelection", "SelectAllTracks", "CopyItems", "SaveEditCursorPosition", "TimeSelectionEnd", "SetRippleEditAllTracks", "FirstTrackWithItem", "Paste", "SetRippleEditOff", "RestoreEditCursorPosition", "RestoreTrackSelection", prefixRepetitionCount=true},
      ...
      eoggleArmAllEnvelopes = "_S&M_TGLARMALLENVS",
      ...
      ToggleRecording = {"SetRecordModeNormal", 1013},
      ToggleRecordMode = lib.state.toggleRecordMode,
      ToggleRecord = {"ToggleRecording", "ToggleRecordMode"},
