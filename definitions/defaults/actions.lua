...
return {
      ...
      DeleteSelectedTracksFromCurrentSnapshot = "_SWSSNAPSHOT_DEL",
      ...
      SaveSelectedTracksToCurrentSnapshot = "_SWSSNAPSHOT_SAVE",
      ...
      CreateNewSnapshotWithSelectedTracks = "_SWSSNAPSHOT_NEWSEL",
