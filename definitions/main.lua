return {
  ...
  command = {
    ...
    ["<SPC>"] = { "+leader commands", {
      ...
      ["a"] = { "+arming", {
                  ["t"] = "ArmToggleSelected",
                  ["i"] = "SetRecordModeInput",
                  ["o"] = "SetRecordModeMidiOutput",
                  ["d"] = "SetRecordModeMidiOverdub",
                  ["t"] = "SetRecordModeMidiTouchReplace",
                  ["r"] = "SetRecordModeMidiReplace",
                  ["m"] = "SetRecordModeMonitorOnly",
                  ["f"] = "SetRecordModeInput",
                  ["v"] = "SetRecordModeMonitorOnly",
            }},
      ["e"] = { "+envelopes", {
