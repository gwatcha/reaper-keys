...
local VariedTextbox = require("gui.element"):new()
VariedTextbox.__index = VariedTextbox
VariedTextbox.defaultProps = {
...
function VariedTextbox:new(props)
...
function VariedTextbox:onDelete()
...
function VariedTextbox:val(newval)
...
function VariedTextbox:onUpdate()
...
function VariedTextbox:onLostFocus()
    self:redraw()
end
...
function VariedTextbox:onMouseDown(state)
...
function VariedTextbox:onDoubleClick(state)
  if state.preventDefault then return end
...
function VariedTextbox:onDrag(state)
  if state.preventDefault then return end
...
function VariedTextbox:onType(state)
  if state.preventDefault then return end
...
function VariedTextbox:onWheel(state)
  if state.preventDefault then return end
...
local previousValue
function VariedTextbox:onGotFocus()
...
function VariedTextbox:getCaptionCoords(w, h)
...
function VariedTextbox:drawCaption()
...
function VariedTextbox:drawText()
...
function VariedTextbox:drawCaret()
...
function VariedTextbox:drawSelection()
...
function VariedTextbox:drawGradient()
...
function VariedTextbox:isSelectionVisible(x, w)
...
function VariedTextbox:selectAll()
...
function VariedTextbox:selectWord()
...
function VariedTextbox:deleteSelection()
...
function VariedTextbox:getSelectedText()
...
VariedTextbox.toClipboard = TextUtils.toClipboard
VariedTextbox.fromClipboard = TextUtils.fromClipboard
...
function VariedTextbox:recalculateWindow()
...
function VariedTextbox:windowRight()
...
-- If not, returns nil
function VariedTextbox:adjustToWindow(x)
...
function VariedTextbox:setWindowToCaret()
...
function VariedTextbox:calcCaretPosition(x)
...
function VariedTextbox:insertString(str, moveCaret)
...
function VariedTextbox:insertChar(char)
...
function VariedTextbox:carettoend()
...
function VariedTextbox:validate()
  return not self.validator or self.validator(self.retval)
end

VariedTextbox.undo = TextUtils.undo
VariedTextbox.redo = TextUtils.redo

VariedTextbox.storeUndoState = TextUtils.storeUndoState

function VariedTextbox:getEditorState()
  return { retval = self.retval, caret = self.caret }
end

function VariedTextbox:setEditorState(retval, caret, windowPosition, selectionStart, selectionEnd)
...
VariedTextbox.SWS_clipboard = TextUtils.SWS_clipboard

return VariedTextbox
