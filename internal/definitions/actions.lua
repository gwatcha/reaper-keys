...
return {
    ...
    NextBeat = 40841,
    NextBigItemEnd = { custom.nextBigItemEnd, prefixRepetitionCount = true },
    NextBigItemStart = { custom.nextBigItemStart, prefixRepetitionCount = true },
    ...
    PrevBigItemStart = { custom.prevBigItemStart, prefixRepetitionCount = true },
    ...
    ProjectEnd = custom.projectEnd,
    ProjectStart = custom.projectStart,
    ProjectTimeline = custom.innerProjectTimeline,
    ...
    SelectOnlyCurrentTrack = custom.onlyCurrentTrack,
    ...
    FirstTrackWithItem = custom.firstTrackWithItem,
    DuplicateTimeline = {
        "SaveTrackSelection",
        "SelectAllTracks",
        "CopyItems",
    ...
    TrackWithNumber = custom.trackWithNumber,
