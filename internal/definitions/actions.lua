local impl = require "actions_impl"
...
-- Foo = impl.foo.bar -- run a lua function
--
...
return {
    ...
    ClearTimeSelection = impl.clearTimeSelection,
    ...
    PrintLog = impl.printLog, -- TODO missing?
    ...
    DeleteItem = 40006,
    DeleteMark = { impl.marks.delete, registerAction = true },
    ...
    FirstItemStart = impl.firstItemStart,
    FirstTrack = { impl.firstTrack, "ScrollToSelectedTracks" },
    ...
    ResetFeedbackWindow = impl.resetFeedbackWindow,
    ...
    LastItemEnd = impl.lastItemEnd,
    LastTrack = { impl.lastTrack, "ScrollToSelectedTracks" },
    ...
    MarkedRegion = { impl.marks.recallMarkedRegion, registerAction = true },
    MarkedTimelinePosition = { impl.marks.recallMarkedTimelinePosition, registerAction = true },
    MarkedTracks = { impl.marks.recallMarkedTracks, registerAction = true },
    Mark = { impl.marks.save, registerAction = true },
    ...
    MatchTrackNameBackward = impl.matchTrackNameBackward,
    MatchTrackNameForward = impl.matchTrackNameForward,
    ...
    NextBeat = 40841,
    NextBigItemEnd = { impl.nextBigItemEnd, prefixRepetitionCount = true },
    NextBigItemStart = { impl.nextBigItemStart, prefixRepetitionCount = true },
    ...
    NextItemEnd = { impl.nextItemEnd, prefixRepetitionCount = true },
    NextItemStart = { impl.nextItemStart, prefixRepetitionCount = true },
    ...
    Paste = { impl.paste, prefixRepetitionCount = true },
    Pause = 1008,
    ...
    PrevBigItemStart = { impl.prevBigItemStart, prefixRepetitionCount = true },
    ...
    PrevItemStart = { impl.prevItemStart, prefixRepetitionCount = true },
    ...
    ProjectEnd = impl.projectEnd,
    ProjectStart = impl.projectStart,
    ProjectTimeline = impl.innerProjectTimeline,
    Quantize = { 40009, midiCommand = true },
    RecallMark = { impl.marks.recall, registerAction = true }, --TODO not working?
    ...
    RepeatTrackNameMatchBackward = impl.repeatTrackNameMatchBackward,
    RepeatTrackNameMatchForward = impl.repeatTrackNameMatchForward,
    ...
    SelectOnlyCurrentTrack = impl.onlyCurrentTrack,
    ...
    FirstTrackWithItem = impl.firstTrackWithItem,
    DuplicateTimeline = {
        "SaveTrackSelection",
        "SelectAllTracks",
        "CopyItems",
    ...
    SetGridDivision = impl.setGridDivision,
    ...
    SetLoopStart = 40222,
    SetMidiGridDivision = impl.setMidiGridDivision,
    SetModeNormal = impl.state.setModeNormal,
    PasteItemFxChain = { "_S&M_COPYFXCHAIN9", prefixRepetitionCount = true },
    SetModeVisualTimeline = impl.state.setModeVisualTimeline,
    ClearSelectedTimeline = impl.clearSelectedTimeline,
    ClearTimelineSelectionAndSetModeVisualTimeline = { "ClearSelectedTimeline", "SetModeVisualTimeline" },
    SetModeVisualTrack = impl.state.setModeVisualTrack,
    SetModeRecord = impl.state.setModeRecord,
    ...
    SplitItemsAtEditCursor = {
        ...
        "UnselectItems" },
    SplitItemsAtTimeSelection = impl.splitItemsAtTimeSelection,
    ...
    SwitchTimelineSelectionSide = impl.state.switchTimelineSelectionSide,
    TapTempo = 1134,
    ...
    TrackWithNumber = impl.trackWithNumber,
